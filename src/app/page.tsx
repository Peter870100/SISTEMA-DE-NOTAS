  ...
  return (
    <main className="mx-auto flex w-full min-w-0 max-w-6xl flex-1 flex-col gap-6 px-4 py-8 sm:px-6 sm:py-12">
      <div className="flex flex-col items-center gap-3 text-center">
        <h1 className="rounded-full bg-blue-600 px-12 py-5 text-3xl font-bold tracking-wide text-white shadow-md shadow-blue-600/30 sm:px-16 sm:py-6 sm:text-4xl">
          AVALIA
        </h1>
